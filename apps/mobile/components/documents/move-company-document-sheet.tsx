...
export interface MoveCompanyDocumentSheetHandle {
	present: (document: CompanyDocument) => void;
}

export function MoveCompanyDocumentSheet({
	ref,
}: {
	ref?: Ref<MoveCompanyDocumentSheetHandle>;
}) {
	...
	const move = useAction(api.companyDocuments.move.move);
	const contents = useQuery(
		api.companyDocuments.listContents.listContents,
		document ? { folderPath: targetPath } : 'skip'
	) as { folders: CompanyFolder[]; documents: CompanyDocument[] } | undefined;
