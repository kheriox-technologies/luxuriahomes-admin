...
export interface InclusionNotesSheetHandle {
...
export function InclusionNotesSheet({
	ref,
}: {
	ref?: Ref<InclusionNotesSheetHandle>;
}) {
	...
	const appendNote = useMutation(api.projectInclusions.appendNote.appendNote);
	const deleteNote = useMutation(api.projectInclusions.deleteNote.deleteNote);
