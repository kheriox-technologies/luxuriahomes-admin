...
/**
 * Lets a project client attach images to a note. Uploads each selected file to
 * S3 via the client-portal upload action and reports the resulting S3 keys to
 * the parent through `onChange`. Renders only the selected-image previews; call
 * `open()` on the ref to launch the file picker. Remount to reset.
 */
