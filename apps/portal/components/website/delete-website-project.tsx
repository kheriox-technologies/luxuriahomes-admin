...
export default function DeleteWebsiteProject({
	websiteProjectId,
	projectName,
	trigger,
	open: controlledOpen,
	...
	const removeWebsiteProject = useMutation(api.websiteProjects.remove.remove);
	const router = useRouter();

	const onDelete = async () => {
		setIsDeleting(true);
		try {
			await removeWebsiteProject({ websiteProjectId });
			toastManager.add({
