...
`)};return f?f.pathname.match(/\[\[\.\.\..+]]/)||j():(async()=>{let b;if(e.current++,!(e.current>1)){try{let c=`${window.location.origin}${window.location.pathname}/${a}_clerk_catchall_check_${Date.now()}`;b=await fetch(c,{signal:i.signal})}catch{}(null==b?void 0:b.status)===404&&j()}})(),()=>{e.current>1&&i.abort()}},[h])})(b,e,f.routing,d),f}a.s(["usePagesRouter",()=>aL],781914);let aN=Object.assign(a=>y.default.createElement(l.UserProfile,{...aM("UserProfile",a)}),{...l.UserProfile}),aO=Object.assign(a=>y.default.createElement(l.OrganizationProfile,{...aM("OrganizationProfile",a)}),{...l.OrganizationProfile}),aP=a=>y.default.createElement(l.SignIn,{...aM("SignIn",a,!1)}),aQ=a=>y.default.createElement(l.SignUp,{...aM("SignUp",a,!1)});a.s(["OrganizationProfile",()=>aO,"SignIn",()=>aP,"SignUp",()=>aQ,"UserProfile",()=>aN],731583)}];

//# sourceMappingURL=node_modules_4a069583._.js.map